...
public class RestExceptionHandler extends BaseExceptionHandler {
    ...
    public ResponseEntity<Map<String, String>> handleUUIDFormatException(MethodArgumentTypeMismatchException ex, HttpServletRequest request) {
    ...
    public ResponseEntity<Map<String, String>> handleInvalidJson(HttpMessageNotReadableException ex, HttpServletRequest request) {
